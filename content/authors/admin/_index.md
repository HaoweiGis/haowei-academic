...
**编程技能和平台框架**：Python (GDAL, Numpy, Scikit-learn, etc.)，Pytorch (网络结构设计，Attention，Transformer, etc.), SQL (PostgreSQL, PostGIS, and related function), 地球大数据平台GEE和相关底层技术 (Spark, Geomesa, Geotrellis) 
